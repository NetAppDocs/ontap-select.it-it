...
`-username _username_`
 a| 
Il nome utente che ha accesso a questo host. Questo è obbligatorio solo se l'host non è gestito da un server di gestione (cioè, un host ESXi gestito da un vCenter).
