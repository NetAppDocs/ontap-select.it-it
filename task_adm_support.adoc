...
. Seleziona *Impostazioni e AutoSupport*, quindi seleziona image:icon_pencil.gif["Modifica"].
. Fornisci i dati di configurazione appropriati per il tuo ambiente e seleziona *Modifica*.
+
...
. Accedere all'interfaccia utente Web dell'utilità di implementazione utilizzando l'account amministratore.
. Selezionare la scheda *Amministrazione* nella parte superiore della pagina.
. Seleziona *Eventi & lavori*, quindi seleziona *Eventi*.
. Facoltativamente, seleziona *Filtro* e crea un filtro per limitare i messaggi degli eventi visualizzati.
...
. Accedere all'interfaccia utente Web dell'utilità di implementazione utilizzando l'account amministratore.
. Selezionare la scheda *Amministrazione* nella parte superiore della pagina.
. Seleziona *Impostazioni e AutoSupport* e poi seleziona image:icon_kebab.gif["Opzioni"].
...
. Facoltativamente, seleziona il pacchetto corretto in *AutoSupport History*, quindi seleziona l'icona di download per salvare il file AutoSupport sulla tua workstation locale.
