...
Le licenze standard, premium e premium XL supportano un'ampia gamma di hardware e software. Per informazioni aggiornate sulle versioni hardware e software, consultare il link:https://mysupport.netapp.com/matrix/["Tool di matrice di interoperabilità"^].
...
2+| Famiglia CPU  a| 
Intel Xeon E5-26xx v3 (Haswell) o versione successiva

AMD EPYC Embedded 9004 o versioni successive e 8004
 a| 
Intel Xeon E5-26xx v3 (Haswell) o versione successiva
...
====
.Cosa succederà ora?
Scopri di piùlink:concept_lic_workflow.html["acquisto di una licenza ONTAP Select"]
