...
* Categoria Le chiamate API sono organizzate nella pagina della documentazione in aree o categorie funzionalmente correlate. Per individuare una chiamata API specifica, scorri fino in fondo alla pagina e seleziona la categoria API corrispondente.
