...
È possibile assegnare quattro gruppi di porte a ciascun nodo in un cluster multi-nodo. Ogni gruppo di porte ha una singola porta fisica attiva e tre porte fisiche in standby come nella figura seguente.
