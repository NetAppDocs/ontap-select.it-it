...
NOTE: L'API REST inclusa in ONTAP Select Deploy ha un numero di versione assegnato. Il numero di versione dell'API è indipendente dal numero di rilascio di Deploy. L'utility di amministrazione ONTAP Select 9.19.1 Deploy include la versione 3 dell'API REST.
