...
Se si utilizzano queste versioni precedenti e si tenta un aggiornamento, è possibile lasciare la macchina virtuale ONTAP Select in uno stato in cui non può essere avviata. In questo caso, è necessario selezionare una procedura di aggiornamento che non utilizzi Deploy.
