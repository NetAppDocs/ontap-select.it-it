...
È possibile accedere a. https://library.netapp.com/ecm/ecm_download_file/ECMLP2885795["Note sulla versione di ONTAP Select 9.13.1"^] per visualizzare i dettagli sulla versione corrente.
