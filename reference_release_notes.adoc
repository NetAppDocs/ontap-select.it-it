...
È possibile accedere a link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3332465["Note sulla versione di ONTAP Select 9.16.1"^]per visualizzare i dettagli sulla versione corrente.
