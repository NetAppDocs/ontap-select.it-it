...
---
= Requisiti di storage esterno VMware ESXi per ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Consultare la documentazione VMware e seguire le best practice applicabili identificate per gli host ESXi. Inoltre:
...
* Verificare che tutti gli array di storage esterni generici utilizzino le funzionalità di ridondanza e HA disponibili ove possibile
