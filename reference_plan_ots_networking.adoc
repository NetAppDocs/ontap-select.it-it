...
NOTE: Per saperne di più su come configurare un vSwitch su un host hypervisor e sulla funzionalità dell'interfaccia ad alta velocità, fare riferimento alla sezione link:concept_nw_concepts_chars.html["Networking di approfondimento"].
...
Fare riferimento alla sezione link:concept_nw_concepts_chars.html["Networking di approfondimento"] per ulteriori informazioni sulle distribuzioni con due NIC.
...
Fare riferimento alla sezione link:concept_nw_concepts_chars.html["Networking di approfondimento"] per ulteriori informazioni sulle distribuzioni con quattro NIC.
