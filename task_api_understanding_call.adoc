...
.Fasi
. Nella pagina principale, scorri fino in fondo e seleziona *Cluster*.
. Seleziona *GET /clusters/{cluster_id}* per visualizzare i dettagli della chiamata API utilizzata per restituire informazioni su un ONTAP Select cluster.
