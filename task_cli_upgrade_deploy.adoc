...
È possibile eseguire l'aggiornamento diretto a ONTAP Select Deploy 9.19.1 da ONTAP Select Deploy 9.18.1 o 9.17.1. Per eseguire l'aggiornamento da una versione precedente, ad esempio ONTAP Select Deploy 9.16.1, è necessario prima eseguire l'aggiornamento a ONTAP Select Deploy 9.17.1 o 9.18.1, quindi eseguire l'aggiornamento a ONTAP Select Deploy 9.19.1.

[NOTE]
====
Se hai una versione precedente dell'utilità di amministrazione ONTAP Select Deploy installata, dovresti aggiornarla alla versione corrente. È necessario aggiornare i componenti ONTAP Select node e ONTAP Select Deploy in modo indipendente. Consulta link:concept_adm_upgrading_nodes.html["Aggiornare i nodi ONTAP Select"^] per ulteriori dettagli.
