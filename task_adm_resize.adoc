...
. Seleziona la scheda *Cluster* nella parte superiore della pagina, quindi seleziona il cluster desiderato dall'elenco.
. Nella pagina dei dettagli del cluster, seleziona l'icona a forma di ingranaggio a destra della pagina e seleziona *Ridimensiona istanza*.
. Seleziona il *Tipo di istanza* e inserisci le credenziali ONTAP, quindi seleziona *Modifica*.
