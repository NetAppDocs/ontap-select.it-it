...
Sito Web per le licenze:: È possibile ottenere una licenza Capacity Tier e una licenza Capacity Pool su siti web diversi.
...
.Cosa succederà ora?
Scopri le considerazioni per il dimensionamento di una licenza ONTAP Select:

* link:sizing-capacity-tier-license.html["Licenza Capacity Tiers"]
* link:sizing-capacity-pool-license.html["Licenza Capacity Pools"]


.Informazioni correlate
link:task_adm_licenses.html["Scopri come gestire le licenze ONTAP Select"]
