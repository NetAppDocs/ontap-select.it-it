...
* SnapLock Select
+
SnapLock Select è l'implementazione di ONTAP SnapLock progettata per ONTAP Select e include SnapLock Enterprise. Non include SnapLock Compliance. Per ulteriori informazioni, consultare il link:https://docs.netapp.com/us-en/ontap/snaplock/index.html["Documentazione ONTAP SnapLock"^].
