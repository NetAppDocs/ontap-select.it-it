...
. Seleziona la scheda *Amministrazione* nella parte superiore della pagina, quindi seleziona *Mediatori*.
. Facoltativamente, seleziona *Filtro* per personalizzare la visualizzazione dei cluster a due nodi monitorati dal servizio mediatore.
