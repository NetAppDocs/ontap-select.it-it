...
.Fasi
I passaggi da seguire variano a seconda che si desideri creare un cluster a nodo singolo o multi-nodo. Un cluster multi-nodo può avere due, quattro, sei, otto, dieci o dodici nodi.
