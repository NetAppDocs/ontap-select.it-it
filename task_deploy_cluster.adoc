...
Dopo aver distribuito il cluster, confermare che la funzionalità ONTAP Select AutoSupport sia configurata e quindilink:task_cli_clusters.html["eseguire il backup dei dati di configurazione ONTAP Select Deploy"] .
